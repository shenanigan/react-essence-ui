...
export const GridPage = () => {
	...
	const [tilesContainers] = useState<GridTileProps[]>([
		{
			frontTile: (
				<NotificationTile
					badge="1"
					title="Notifications"
					iconUrl="https://img.icons8.com/ios11/512/windows-10.png"
				/>
			),
			backTile: (
		...
		},
		{
			frontTile: (
				<MailTile
					...
					preview="This is a nice preview text. Would you like to meet for a coffee? This is a nice preview text. Would you like to meet for a coffee? This is a nice preview text. Would you like to meet for a coffee?"
	...
	return (
		<div className="docs-markdown">
			...
			<Grid
				className={'mt-3'}
				onTileSizeChanged={(key, variant, tiles) => {
					console.log('onTileSizeChanged', key, variant, tiles);
				}}
